...
description: Project-local wrapper for the trusted global principle-auditor role
---

# principle-auditor

This Agent Catalog wrapper exists only to make the trusted global
`principle-auditor` role discoverable from a projected project.

When selected:
- Use for: Audit plans and architecture changes against Agent Harness P1-P4 principles.
- Reason: the user request matches this role's focused responsibility.
- The trusted global role remains
  `$AGENTOS_HOME/core/.agents/agents/harness/principle-auditor.md`.
