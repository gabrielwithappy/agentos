...
def _touched_paths(payload: dict) -> list[str]:
    ...
    # Codex apply_patch: the touched paths are embedded in the unified
    # patch envelope carried as tool_input["command"], not a discrete
    # file_path key (payload shape confirmed against Codex CLI hook docs).
