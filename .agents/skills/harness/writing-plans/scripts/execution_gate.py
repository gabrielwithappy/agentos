...
def main():
    parser = argparse.ArgumentParser(description="Execution Gate for checking plan review status")
    parser.add_argument("--plan", required=True, help="Path to the active plan")
