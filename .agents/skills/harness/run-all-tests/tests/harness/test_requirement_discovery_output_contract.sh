...
grep -Eq '.agentos/project` 문서 준비 상태' .agents/skills/harness/requirement-discovery/SKILL.md
...
grep -Eq ".agentos/project/reference/implementation/01-requirement-brief.md" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq ".agentos/project/reference/implementation/02-user-stories.md" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq ".agentos/project/reference/implementation/03-rtm.md" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq ".agentos/project/reference/implementation/04-implementation-guide.md" .agents/skills/harness/requirement-discovery/SKILL.md
...
grep -Eq ".agentos/project/reference/implementation/02-user-stories.md" .agents/agents/harness/goal-alignment-reviewer.md
grep -Eq ".agentos/project/reference/implementation/03-rtm.md" .agents/agents/harness/goal-alignment-reviewer.md
grep -Eq ".agentos/project/reference/implementation/04-implementation-guide.md" .agents/agents/harness/goal-alignment-reviewer.md
...
grep -Eq '.agentos/project` 문서 준비 상태' catalog/agents/document-delivery-lead/AGENT.md
...
grep -Eq "개발 입력 문서 패키지" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq "User Stories" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq "RTM" .agents/skills/harness/requirement-discovery/SKILL.md
grep -Eq "Implementation Guide" .agents/skills/harness/requirement-discovery/SKILL.md
