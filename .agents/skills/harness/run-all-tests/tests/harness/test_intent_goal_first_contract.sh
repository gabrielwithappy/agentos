...
require_pattern ".agentos/project/02-product-scope-and-requirements.md" "REQ-HARNESS-002"
require_pattern ".agentos/project/02-product-scope-and-requirements.md" "요구사항"
require_pattern ".agentos/project/02-product-scope-and-requirements.md" "비목표"
require_pattern ".agentos/project/05-agent-operating-contract.md" "계획 인터뷰 계약"
require_pattern ".agentos/project/05-agent-operating-contract.md" "one clear question"
require_pattern ".agentos/project/05-agent-operating-contract.md" "표면적인 작업 방식"
require_pattern ".agentos/project/05-agent-operating-contract.md" "선택지를 통해 자기 의도를 스스로 확인"
