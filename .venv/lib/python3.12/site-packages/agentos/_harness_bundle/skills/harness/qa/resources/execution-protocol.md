...
2. **Check lessons** — read QA section in `../brain/resources/lessons-learned.md`
...
4. **Budget context** — follow `../brain/resources/context-budget.md` (prioritize high-risk files)
5. **After review**: add recurring issues to `../brain/resources/lessons-learned.md`
...
- Run `../brain/resources/common-checklist.md` for general quality
