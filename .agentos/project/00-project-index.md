...
| `reference/implementation/2026-07-23-pi-tui-cloning-roadmap.md` | `03-system-contract.md` | 현재 | Phase 5 이후 pi TUI 기능을 선행 조건과 AgentOS 계약 영향으로 나눈 장기 이식 로드맵과 Phase 6 입력 상호작용 기반 범위. | Refresh when each TUI cloning phase closes or the pi reference revision changes. |
