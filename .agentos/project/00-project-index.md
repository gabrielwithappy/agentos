...
| `reference/decisions/0006-agentos-vendor-neutral-project-work-harness.md` | `01-project-charter.md`, `02-product-scope-and-requirements.md`, `03-system-contract.md`, `04-safety-risk-verification.md`, `05-agent-operating-contract.md`, and `06-decisions-change-log.md` | 현재 | AgentOS를 vendor-neutral project work harness로 정의하는 control/execution/bridge ownership 결정과 0004/0005와의 우선순위 관계 기록. | Refresh when control/execution/bridge ownership, default user journey, native-runtime expansion approval, or the relationship to 0004/0005 changes. |
