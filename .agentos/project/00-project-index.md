...
- decisions, progress, change history, and next safe action
...
6. Use `06-decisions-progress-change-log.md` to record accepted decisions and 현재 progress.
...
7. Read `06-decisions-progress-change-log.md` for decision, progress, change, and handoff state.
...
| Decisions and progress | `06-decisions-progress-change-log.md` | reviews, experiment notes, closeout packets | Root log records accepted 현재 state. |
...
| `reference/decisions/` | `03-system-contract.md`, `05-agent-operating-contract.md`, and `06-decisions-progress-change-log.md` | 현재 | ADR-style decision records, architecture rationale, reviews/audits, experiment notes, and handoff-sized context. | Refresh when a decision is accepted, review evidence changes, or long-lived architecture context is revised. |
...
- decisions, progress, change evidence, and handoff state in `06-decisions-progress-change-log.md`
