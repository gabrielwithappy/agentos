...
- 사용자의 목적, 기대 변화, 완료 기준을 먼저 확인하고 표면적인 작업 방식 질문은 뒤로 미룬다.
- 한 번에 one clear question만 묻고, 코드베이스와 project documents에서 이미 확인된 내용은 반복 질문하지 않는다.
- 선택지는 파일·스택이 아니라 사용자가 원하는 결과를 스스로 확인하는 목적 후보로 제시한다(선택지를 통해 자기 의도를 스스로 확인).
