...
- [x] **Step 1: independent principle audit evidence, architect approval, manifest update/check를 실행한다.**
...
- [x] **Step 2: full harness suite and project public verifier를 실행하고 closeout evidence를 기록한다.**
...
- [x] **Step 3: reusable change의 durable evolution record를 갱신하고 재생성한다.**
