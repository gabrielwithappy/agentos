...
- [ ] Run: `python3 /home/gabriel/agent/prj-agent/agentos-workspace/agentos/catalog/skills/knowledge-curator/scripts/knowledge.py validate --project /tmp/knowledge-agent` Expected: JSON with `"ok": true`
