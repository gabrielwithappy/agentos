...
## Selecting Optional Skills
You can initialize a project and select optional purpose-grouped skills using:
`agentos project init`

To reselect skills later without losing unmanaged ones:
